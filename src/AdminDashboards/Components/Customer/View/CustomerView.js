            ...
            <div className="row">
              <div className="col-md-6">
                <ul className="list-group">
                  ...
                  <li className="list-group-item">
                    <span className="fw-bold">Alternate No:</span> {data?.alternate_no?? "-"}
                  </li>
                  <li className="list-group-item">
                    <span className="fw-bold">Amount:</span> {data?.blance_amount?? "-"}
                  </li>
                  ...
                  <li className="list-group-item">
                    <span className="fw-bold">Location:</span> {data?.location?? ""}
                  </li>
                  <li className="list-group-item">
                    <span className="fw-bold">Id:</span> {data?.member_id?? ""}
                  </li>
              ...
              <div className="col-md-6">
                <ul className="list-group">
                  ...
                  <li className="list-group-item">
                    <span className="fw-bold">Payment Method.:</span> {data?.payment_method?? ""}
                  </li>
                  <li className="list-group-item">
                    <span className="fw-bold">User Id:</span> {data?.user_id?? "-"}
                  </li>
                  <li className="list-group-item">
                    <span className="fw-bold">Membership:</span> {data?.updatedAt?? ""}
                  </li>
                  <li className="list-group-item">
                    <span className="fw-bold">Payment:</span> {data?.payment?? ""}
                  </li>

                  <li className="list-group-item">
                    <span className="fw-bold">Occupation:</span> {data?.occupation?? ""}
                  </li>
                  <li className="list-group-item">
                    <span className="fw-bold">Office No:</span> {data?.office_no?? ""}
                  </li>
                  <li className="list-group-item">
                    <span className="fw-bold">House:</span> {data?.own_house?? ""}
                  </li>
                </ul>
              </div>
            </div>
