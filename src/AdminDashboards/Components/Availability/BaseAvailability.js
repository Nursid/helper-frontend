...
import { GridToolbarExport, GridToolbarQuickFilter, GridToolbarColumnsButton, GridToolbarFilterButton, GridToolbarDensitySelector } from "@mui/x-data-grid";
...
const BaseAvailability = ({ availabilityType, title }) => {
    ...
    const fetchAllStatuses = async (data) => {
        ...
        try {
            const statusMap = {};
            for (const order_no of orderNumbers) {
                const response = await axios.get(`${API_URL}/order/getbyorderno/${order_no}`);
                const pendingStatus = response?.data?.data?.pending;
                ...
                statusMap[order_no] = statusClassesMap[pendingStatus] || '';
            }
            setStatusClasses(statusMap);
        } catch (error) {
    ...
    const getCellClassName = (params) => {
        ...
        if (params?.value && !params.value.includes("MonthlyService")) {
            ...
            const numericPart = splitValue[1];
            return statusClasses[numericPart] || '';
        }
    ...
    const colums = [
        ...
        { field: "07:00-07:30", headerName: "07:00-07:30 AM", minWidth: 150, cellClassName: getCellClassName },
        { field: "07:30-08:00", headerName: "07:30-08:00 AM", minWidth: 150, cellClassName: getCellClassName },
        { field: "08:00-08:30", headerName: "08:00-08:30 AM", minWidth: 150, cellClassName: getCellClassName },
        { field: "08:30-09:00", headerName: "08:30-09:00 AM", minWidth: 150, cellClassName: getCellClassName },
        { field: "09:00-09:30", headerName: "09:00-09:30 AM", minWidth: 150, cellClassName: getCellClassName },
