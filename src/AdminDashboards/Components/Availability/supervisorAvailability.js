...
const SupervisorAvailability = () => {
    ...
    return (
        ...
        /> */}
                ...
                <h4 className='p-3 px-4 mt-3 bg-transparent text-white headingBelowBorder' style={{ maxWidth: "25rem", width: "25rem" }}>Supervisor Availability</h4>
